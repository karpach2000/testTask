...
public class Main
{
    ...
    private static void nestingDegree2()
    {
        ...
        Tuple3<Long, Long, HashMap<Long, HashSet<Long>>> nestingDegree1 = connections.reduce((a, b) -> {
            Tuple3<Long, Long, HashMap<Long, HashSet<Long>>> tuple = new Tuple3<>(0L, 0L,a._3());
            b._3().forEach((k,v)-> {
            ...
            if(tuple._3().containsKey(a._2()))
                tuple._3().get(a._1()).addAll(tuple._3().get(a._2()));

            tuple._3().get(b._1()).add(b._2());
            if(tuple._3().containsKey(b._2()))
                tuple._3().get(b._1()).addAll(tuple._3().get(b._2()));

            return tuple;
        });
        nestingDegree1._3().remove(0);
        System.out.println("Nesting degree 1: " + nestingDegree1._3());
        sparkContext.close();
    }

    private static void nestingDegree1()
    {
        ArrayList<Tuple2<Long, Long>> calls =new  ArrayList<Tuple2<Long, Long>>();
        calls.add(new Tuple2(1l, 2l));
